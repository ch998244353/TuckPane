...
Current version: **3.0.1**. See the [Latest Release](https://github.com/ch998244353/TuckPane/releases/latest) for the complete release notes.

- [TuckPane-3.0.1-win-x64-setup.exe](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/TuckPane-3.0.1-win-x64-setup.exe): recommended per-user offline installer with Start menu and desktop shortcuts.
- [TuckPane-3.0.1-win-x64-portable.zip](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/TuckPane-3.0.1-win-x64-portable.zip): extract it and run `00-启动 TuckPane.exe`.
- [SHA256SUMS.txt](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/SHA256SUMS.txt): SHA-256 checksums for both downloads.
...
**Move organizer files to Desktop when deleting** is enabled by default. The pane is removed only after its whole directory moves successfully; a failure or cancellation retains the pane and source directory. Open notes stay open and save to their rebound Desktop paths. Turn it off to remove only the pane while leaving its directory and files in place. Uninstalling TuckPane does not delete organizer files or settings.
