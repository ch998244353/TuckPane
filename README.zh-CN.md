...
当前版本：**3.0.1**。完整发布说明请查看 [Latest Release](https://github.com/ch998244353/TuckPane/releases/latest)。

- [TuckPane-3.0.1-win-x64-setup.exe](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/TuckPane-3.0.1-win-x64-setup.exe)：推荐使用的当前用户离线安装器，创建开始菜单和桌面快捷方式。
- [TuckPane-3.0.1-win-x64-portable.zip](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/TuckPane-3.0.1-win-x64-portable.zip)：解压后双击 `00-启动 TuckPane.exe`。
- [SHA256SUMS.txt](https://github.com/ch998244353/TuckPane/releases/download/v3.0.1/SHA256SUMS.txt)：两个下载文件的 SHA-256 校验值。
...
“删除收纳窗时将文件移到桌面”默认开启：TuckPane 只在整个保存目录成功移动后删除窗口，失败或取消时保留原目录和窗口；已打开便签会保持打开并改为保存到桌面新路径。关闭后只删除窗口，目录与文件留在原路径。卸载 TuckPane 不会删除收纳文件或设置。
